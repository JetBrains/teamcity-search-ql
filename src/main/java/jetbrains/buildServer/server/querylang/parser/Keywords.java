...
public class Keywords extends Lexer {
	...
	public static final int
		...
		ANCESTOR_OR_SELF=15, RULES=16, DEPENDENCY=17, ARTIFACT=18, SNAPSHOT=19, 
		ALL=20, OR=21, AND=22, NOT=23, STRING=24, IDENT=25, SUFFIXS=26, PREFIXS=27, 
		SUBSTRINGS=28, WS=29;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ANCESTOR", "ANCESTOR_OR_SELF", "RULES", "DEPENDENCY", "ARTIFACT", "SNAPSHOT", 
			"ALL", "OR", "AND", "NOT", "STRING", "IDENT", "SUFFIXS", "PREFIXS", "SUBSTRINGS", 
			"WS"
		};
	}
