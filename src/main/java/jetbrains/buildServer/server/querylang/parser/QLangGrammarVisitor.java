...
public interface QLangGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link QLangGrammarParser#cleanFilter}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCleanFilter(QLangGrammarParser.CleanFilterContext ctx);
	/**
	 * Visit a parse tree produced by {@link QLangGrammarParser#revRuleFilter}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	T visitFilterModifier(QLangGrammarParser.FilterModifierContext ctx);
	/**
	 * Visit a parse tree produced by {@link QLangGrammarParser#modifierList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
